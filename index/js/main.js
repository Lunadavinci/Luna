...
$('[data-vista="modificar"] form').on("submit", function () {
    ...
    $('[data-modificando]').children("div").children("p:nth-of-type(3)").text(sDate);
    $('[data-modificando]').children("div").children("p:nth-of-the-type(4)").text(detalles);
    $('[data-modificando]').children("div").children("p:nth-of-type(5)").text(operacion);
